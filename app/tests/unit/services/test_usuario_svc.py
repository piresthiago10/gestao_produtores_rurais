...
async def test_get_by_cpf_cnpj(get_db, users_in_db):
    ...
    # erro ao buscar
    with mock.patch(
        "app.database.crud_usuario.CRUD_Usuario.get_by_cpf_cnpj") as get_by_cpf_cnpj_mock:
...
async def test_get_by_email(get_db, users_in_db):
    ...
    # erro ao buscar
    with mock.patch("app.database.crud_usuario.CRUD_Usuario.get_by_email") as get_by_email_mock:
...
async def test_get_all_usuarios(get_db, users_in_db):
    ...
    # erro ao buscar
    with mock.patch(
        "app.database.crud.CRUD.get_all") as get_all_mock:
